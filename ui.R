...
fluidPage(
    ...
    tabsetPanel( id = "tabset",
      ...
      tabPanel("Calculator", style="text-align:justify;color:black;background-color:#f2efea;padding:15px;border-radius:10px；font-family:Arial ;font-size: 1.3359rem;",
      ...
      card(
        ...
        p(
          HTML("r<sub>0</sub> is the value of r that results in null association<br />
               RR<sub>exact</sub> is the RR that would have been observed on adjustment for the Perfect Confounder Score")
        ),
        
        h5("Enter RRs from RDC website"),
        layout_column_wrap(
        ...
        layout_column_wrap(
          ...
          layout_column_wrap(
            ...
            gap = "1rem",
            value_box(
              value = textOutput("B_basic"), 
              title = "B", 
              theme = "success", 
              p("Basic"), 
              style = "height: 100px;font-size: 0.9rem;padding: 0.5rem;"
            )
          )
        ),
        layout_column_wrap(
          ...
          layout_column_wrap(
            ...
            value_box(value = uiOutput("r02_adj"), title = markdown("% reduction (r<sub>0</sub><sup>2</sup>)"), theme = "success", p("Adjusted")),
            value_box(value = uiOutput("r0_adj"), title = markdown("r<sub>0</sub>"), theme = "success", p("Adjusted")),
            value_box(value = uiOutput("Bexact_adj"), title = markdown("B<sub>exact</sub>"), theme = "success", p("Adjusted")),
            value_box(value = uiOutput("RRexact_adj"), title = markdown("RR<sub>exact</sub>"), theme = "success", p("Adjusted"))
          )
        ),
        #End of part 1
        tags$hr(),
      ...
      layout_column_wrap(
        ...
        style = "padding-bottom: 1rem;",
          card(
            ...
            card_body(
              p("Estimated (plausible):"),
              splitLayout(
                cellWidths = c("auto", "40px", "40px"),
                numericInput("es1", NULL, value = 0.80, step = 0.01, width = "100%"),
                actionButton("dec_es1", "-", style = "height:100%; width:100%"),
                actionButton("inc_es1", "+", style = "height:100%; width:100%"),
                #spacing = "0.5rem"
              )
            )
          ),
          card(
            ...
            card_body(
              ...
              splitLayout(
                cellWidths = c("auto", "40px", "40px"),
                numericInput("erdr1", NULL, value = 0.65, step = 0.01, width = "100%"),
                actionButton("dec_erdr1", "-", style = "height:100%; width:100%"),
                actionButton("inc_erdr1", "+", style = "height:100%; width:100%"),
                #spacing = "0.5rem"
              )
            )
          )
      ...
      layout_column_wrap(
        ...
        layout_column_wrap(
          width = 1/3,
          style = "padding-right: 1rem;",
          value_box(value = uiOutput("es_r2_1"), title = markdown("% reduction (r<sup>2</sup>)"), theme = "success", p(""), width = "100px"),
          value_box(value = uiOutput("es_bexact_1"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p("")),
          value_box(value = uiOutput("es_rrexact_1"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p(""))
        ),
        layout_column_wrap(
          width = 1/3,
          style = "padding-left: 1rem;",
          value_box(value = uiOutput("es_rdrc_1"), title = markdown("RDR-corrected RR<sub>exact</sub>"), theme = "success", p(""))
        )
      ),
      ...
      layout_column_wrap(
        ...
        card(
          card_body(
            h5("Estimated (plausible):"),
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("es2", NULL, value = 0.70, step = 0.01, width = "100%"),
              actionButton("dec_es2", "-", style = "height:100%; width:100%"),
              actionButton("inc_es2", "+", style = "height:100%; width:100%"),
              #spacing = "0.5rem"
            )
          )
        ),
        card(
          card_body(
            ...
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("erdr2", NULL, value = 0.65, step = 0.01, width = "100%"),
              actionButton("dec_erdr2", "-", style = "height:100%; width:100%"),
              actionButton("inc_erdr2", "+", style = "height:100%; width:100%"),
              spacing = "0.5rem"
            )
          )
        )
      ...
      layout_column_wrap(
        ...
        layout_column_wrap(
          width = 1/3,
          style = "padding-right: 1rem;",
          value_box(value = uiOutput("es_r2_2"), title = markdown("% reduction (r<sup>2</sup>)"), theme = "success", p(""), width = "100px"),
          value_box(value = uiOutput("es_bexact_2"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p("")),
          value_box(value = uiOutput("es_rrexact_2"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p(""))
        ),
        layout_column_wrap(
          width = 1/3,
          style = "padding-left: 1rem;",
          value_box(value = uiOutput("es_rdrc_2"), title = markdown("RDR-corrected RR<sub>exact</sub>"), theme = "success", p(""))
        )
      ),
      ...
      layout_column_wrap(
        ...
        card(
          card_body(
            ...
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("es3", NULL, value = 0.60, step = 0.01, width = "100%"),
              actionButton("dec_es3", "-", style = "height:100%; width:100%"),
              actionButton("inc_es3", "+", style = "height:100%; width:100%"),
              #spacing = "0.5rem"
            )
          )
        ),
        card(
          card_body(
            ...
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("erdr3", NULL, value = 0.65, step = 0.01, width = "100%"),
              actionButton("dec_erdr3", "-", style = "height:100%; width:100%"),
              actionButton("inc_erdr3", "+", style = "height:100%; width:100%"),
              spacing = "0.5rem"
            )
          )
        )
      ...
      layout_column_wrap(
        ...
        layout_column_wrap(
          width = 1/3,
          style = "padding-right: 1rem;",
          value_box(value = uiOutput("es_r2_3"), title = markdown("% reduction (r<sup>2</sup>)"), theme = "success", p(""), width = "100px"),
          value_box(value = uiOutput("es_bexact_3"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p("")),
          value_box(value = uiOutput("es_rrexact_3"), title = markdown("% reduction (r<sub>02</sub>)"), theme = "success", p(""))
        ),
        layout_column_wrap(
          width = 1/3,
          style = "padding-left: 1rem;",
          value_box(value = uiOutput("es_rdrc_3"), title = markdown("RDR-corrected RR<sub>exact</sub>"), theme = "success", p(""))
        )
      ),
      ...
      h5(HTML("Enter RR<sub>adj</sub> to estimate what the correlation between measured confounders and Perfect Confounder Score would have to be for this RR<sub>adj</sub>")),
      layout_column_wrap(
        width = 1/2,
        card(
          card_body(
            h5(HTML("Estimated RR<sub>adj</sub>:")),
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("erradj", NULL, value = 1.30, step = 0.01, width = "100%"),
              actionButton("dec_erradj", "-", style = "height:100%; width:100%"),
              actionButton("inc_erradj", "+", style = "height:100%; width:100%"),
              #spacing = "0.5rem"
            )
          )
        ),
        card(
          card_body(
            ...
            splitLayout(
              cellWidths = c("auto", "40px", "40px"),
              numericInput("erdr4", NULL, value = 0.65, step = 0.01, width = "100%"),
              actionButton("dec_erdr4", "-", style = "height:100%; width:100%"),
              actionButton("inc_erdr4", "+", style = "height:100%; width:100%"),
              spacing = "0.5rem"
            )
          )
        )
      ...
      layout_column_wrap(
        ...
        layout_column_wrap(
          width = 1/2,
          style = "padding-right: 1rem;",
          value_box(value = uiOutput("r02_rr_adj"), title = markdown("% reduction (r<sub>0</sub><sup>2</sup>)"), theme = "success", p(""), width = "100px"),
          value_box(value = uiOutput("r0_rr_adj"), title = markdown("% reduction (r<sub>0</sub>)"), theme = "success", p(""))
        ),
        layout_column_wrap(
          width = 1/2,
          style = "padding-left: 1rem;",
          value_box(value = uiOutput("es_rdrc_4"), title = markdown("RDR-corrected RR<sub>exact</sub>"), theme = "success", p(""))
        )
      )
      ),
      #--end calculator----
